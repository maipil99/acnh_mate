...
{
    [BsonElement("month-northern")]
    public string MonthNorthern { get; set; }

    [BsonElement("month-southern")]
    ...
    [BsonElement("month-array-northern")]
    public List<int> MonthArrayNorthern { get; set; }

    [BsonElement("month-array-southern")]
    public List<int> MonthArraySouthern { get; set; }

    [BsonElement("time-array")]
